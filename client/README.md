...
This should return _Now using node 18.x.x (npm v6.x.x)_
...
| node       | 18.x            | 20.x           | No            | Node 18.x is required for compatibility with Gatsby 3.14.6 and the current build pipeline. Node 20.x introduces breaking changes that affect the build process.                                                               |
